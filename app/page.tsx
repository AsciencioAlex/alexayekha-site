    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <header className="space-y-4 pb-8 border-b">
        ...
        <p className="text-sm text-neutral-500">
          Founder & CTO at OhCargo • Built real-time logistics platform • Crypto treasury infrastructure • Scaled distributed systems across emerging markets
        </p>

        <p className="text-lg leading-relaxed text-neutral-700">
          Designing high-trust infrastructure for logistics, fintech, and emerging markets.
          I focus on reducing operational entropy through architecture, automation, and decision systems.
        </p>
      ...
      <footer className="mt-16 border-t pt-6 text-sm text-neutral-500">
        <div className="flex flex-wrap gap-4 mb-4">
          <a className="hover:text-neutral-700 transition-colors" href="/writing">Writing</a>
          <a className="hover:text-neutral-700 transition-colors" href="/case-studies">Case Studies</a>
          <a className="hover:text-neutral-700 transition-colors" href="/about">About</a>
